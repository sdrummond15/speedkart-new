...
<div id="carouselbanner-wrp-<?php echo $module->id;?>" class="carouselbanner-wrp">
	<div class="carouselbanner-<?php echo $module->id; ?> carouselbanner">
	...
	<ul class="controls-container controls-container-<?php echo $module->id; ?>">
		<li></li>
		<li></li>
	</ul>
</div>
