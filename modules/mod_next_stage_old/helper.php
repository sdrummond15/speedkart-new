...
class modNext_StageHelper
{
    public static function getDataStage()
    {
        ...
        $query->select('s.id AS id_stage, s.id_championship AS id_championship, s.date AS data, c.image AS circuitoimg, s.hour AS horario, k.title AS kartodromo, c.title AS tracado');
