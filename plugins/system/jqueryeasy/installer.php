...
class plgsystemjqueryeasyInstallerScript
{
	...
	public function postflight($type, $parent)
	{
		...
		JFactory::getApplication()->enqueueMessage('<a class="btn btn-primary" href="index.php?option=com_plugins&view=plugins&filter_folder=system&filter_element=jqueryeasy">' . JText::_('PLG_SYSTEM_JQUERYEASY_PLUGIN_SETUP') . '</a>', 'notice');
