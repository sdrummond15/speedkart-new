...
function ckUpdateThumbnail(imgsrc, editor) {
	...
	if (imgsrc.toLowerCase().indexOf(testurl.toLowerCase()) != -1) {
		...
		slideimg.attr('src', SLIDERCK.URIROOTABS + imgsrc);
	}
}
...
function ckAddSlide(slide, position) {
	...
	if (!imgthumb) {
		imgthumb = SLIDERCK.URIROOTABS + 'media/com_sliderck/images/unknown.png';
	} else {
		imgthumb = SLIDERCK.URIROOTABS + imgname;
	}
	...
	if (!imgtarget || imgtarget == 'default') {
		imgtarget = '';
		imgtargetoption = '<option value="default" selected="selected">' + Joomla.JText._('SLIDERCK_DEFAULT', 'default') + '</option><option value="_parent">' + Joomla.JText._('SLIDERCK_SAMEWINDOW', 'same window') + '</option><option value="_blank">' + Joomla.JText._('SLIDERCK_NEWWINDOW', 'new window') + '</option><option value="lightbox">' + Joomla.JText._('SLIDERCK_LIGHTBOX', 'in a Lightbox') + '</option>';
	} else {
		if (imgtarget == '_parent') {
			imgtargetoption = '<option value="default">' + Joomla.JText._('SLIDERCK_DEFAULT', 'default') + '</option><option value="_parent" selected="selected">' + Joomla.JText._('SLIDERCK_SAMEWINDOW', 'same window') + '</option><option value="_blank">' + Joomla.JText._('SLIDERCK_NEWWINDOW', 'new window') + '</option><option value="lightbox">' + Joomla.JText._('SLIDERCK_LIGHTBOX', 'in a Lightbox') + '</option>';
		} else if (imgtarget == 'lightbox') {
			imgtargetoption = '<option value="default">' + Joomla.JText._('SLIDERCK_DEFAULT', 'default') + '</option><option value="_parent">' + Joomla.JText._('SLIDERCK_SAMEWINDOW', 'same window') + '</option><option value="_blank">' + Joomla.JText._('SLIDERCK_NEWWINDOW', 'new window') + '</option><option value="lightbox" selected="selected">' + Joomla.JText._('SLIDERCK_LIGHTBOX', 'in a Lightbox') + '</option>';
		} else {
			imgtargetoption = '<option value="default">' + Joomla.JText._('SLIDERCK_DEFAULT', 'default') + '</option><option value="_parent">' + Joomla.JText._('SLIDERCK_SAMEWINDOW', 'same window') + '</option><option value="_blank" selected="selected">' + Joomla.JText._('SLIDERCK_NEWWINDOW', 'new window') + '</option><option value="lightbox">' + Joomla.JText._('SLIDERCK_LIGHTBOX', 'in a Lightbox') + '</option>';
		}
	}
	...
	if (!slideselect) {
		slideselect = '';
		slideselectoption = '<option value="image" selected="selected">' + Joomla.JText._('SLIDERCK_IMAGE', 'Image') + '</option><option value="video">' + Joomla.JText._('SLIDERCK_VIDEO', 'Video') + '</option>';
	} else {
		if (slideselect == 'image') {
			slideselectoption = '<option value="image" selected="selected">' + Joomla.JText._('SLIDERCK_IMAGE', 'Image') + '</option><option value="video">' + Joomla.JText._('SLIDERCK_VIDEO', 'Video') + '</option>';
		} else {
			slideselectoption = '<option value="image">' + Joomla.JText._('SLIDERCK_IMAGE', 'Image') + '</option><option value="video" selected="selected">' + Joomla.JText._('SLIDERCK_VIDEO', 'Video') + '</option>';
		}
	}
	...
	if (!imgalignment) {
		...
		imgdataalignmentoption = '<option value="default" selected="selected">Default</option>'
				+ '<option value="topLeft">' + Joomla.JText._('SLIDERCK_TOPLEFT', 'top left') + '</option>'
				+ '<option value="topCenter">' + Joomla.JText._('SLIDERCK_TOPCENTER', 'top center') + '</option>'
				+ '<option value="topRight">' + Joomla.JText._('SLIDERCK_TOPRIGHT', 'top right') + '</option>'
				+ '<option value="centerLeft">' + Joomla.JText._('SLIDERCK_MIDDLELEFT', 'center left') + '</option>'
				+ '<option value="center">' + Joomla.JText._('SLIDERCK_CENTER', 'center') + '</option>'
				+ '<option value="centerRight">' + Joomla.JText._('SLIDERCK_MIDDLERIGHT', 'center right') + '</option>'
				+ '<option value="bottomLeft">' + Joomla.JText._('SLIDERCK_BOTTOMLEFT', 'bottom left') + '</option>'
				+ '<option value="bottomCenter">' + Joomla.JText._('SLIDERCK_BOTTOMCENTER', 'bottom center') + '</option>'
				+ '<option value="bottomRight">' + Joomla.JText._('SLIDERCK_BOTTOMRIGHT', 'bottom right') + '</option>';
	} else {
		if (imgalignment == 'topLeft') {
			imgdataalignmentoption = '<option value="default">Default</option>'
					+ '<option value="topLeft" selected="selected">' + Joomla.JText._('SLIDERCK_TOPLEFT', 'top left') + '</option>'
					+ '<option value="topCenter">' + Joomla.JText._('SLIDERCK_TOPCENTER', 'top center') + '</option>'
					+ '<option value="topRight">' + Joomla.JText._('SLIDERCK_TOPRIGHT', 'top right') + '</option>'
					+ '<option value="centerLeft">' + Joomla.JText._('SLIDERCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center">' + Joomla.JText._('SLIDERCK_CENTER', 'center') + '</option>'
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					+ '<option value="topLeft">' + Joomla.JText._('SLIDERCK_TOPLEFT', 'top left') + '</option>'
					+ '<option value="topCenter" selected="selected">' + Joomla.JText._('SLIDERCK_TOPCENTER', 'top center') + '</option>'
					+ '<option value="topRight">' + Joomla.JText._('SLIDERCK_TOPRIGHT', 'top right') + '</option>'
					+ '<option value="centerLeft">' + Joomla.JText._('SLIDERCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center">' + Joomla.JText._('SLIDERCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight">' + Joomla.JText._('SLIDERCK_MIDDLERIGHT', 'center right') + '</option>'
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					+ '<option value="topLeft">' + Joomla.JText._('SLIDERCK_TOPLEFT', 'top left') + '</option>'
					+ '<option value="topCenter">' + Joomla.JText._('SLIDERCK_TOPCENTER', 'top center') + '</option>'
					+ '<option value="topRight" selected="selected">' + Joomla.JText._('SLIDERCK_TOPRIGHT', 'top right') + '</option>'
					+ '<option value="centerLeft">' + Joomla.JText._('SLIDERCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center">' + Joomla.JText._('SLIDERCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight">' + Joomla.JText._('SLIDERCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft">' + Joomla.JText._('SLIDERCK_BOTTOMLEFT', 'bottom left') + '</option>'
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="topCenter">' + Joomla.JText._('SLIDERCK_TOPCENTER', 'top center') + '</option>'
					+ '<option value="topRight">' + Joomla.JText._('SLIDERCK_TOPRIGHT', 'top right') + '</option>'
					+ '<option value="centerLeft" selected="selected">' + Joomla.JText._('SLIDERCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center">' + Joomla.JText._('SLIDERCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight">' + Joomla.JText._('SLIDERCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft">' + Joomla.JText._('SLIDERCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter">' + Joomla.JText._('SLIDERCK_BOTTOMCENTER', 'bottom center') + '</option>'
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="topRight">' + Joomla.JText._('SLIDERCK_TOPRIGHT', 'top right') + '</option>'
					+ '<option value="centerLeft">' + Joomla.JText._('SLIDERCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center" selected="selected">' + Joomla.JText._('SLIDERCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight">' + Joomla.JText._('SLIDERCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft">' + Joomla.JText._('SLIDERCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter">' + Joomla.JText._('SLIDERCK_BOTTOMCENTER', 'bottom center') + '</option>'
					+ '<option value="bottomRight">' + Joomla.JText._('SLIDERCK_BOTTOMRIGHT', 'bottom right') + '</option>';
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="centerLeft">' + Joomla.JText._('SLIDERCK_MIDDLELEFT', 'center left') + '</option>'
					+ '<option value="center">' + Joomla.JText._('SLIDERCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight" selected="selected">' + Joomla.JText._('SLIDERCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft">' + Joomla.JText._('SLIDERCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter">' + Joomla.JText._('SLIDERCK_BOTTOMCENTER', 'bottom center') + '</option>'
					+ '<option value="bottomRight">' + Joomla.JText._('SLIDERCK_BOTTOMRIGHT', 'bottom right') + '</option>';
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="center">' + Joomla.JText._('SLIDERCK_CENTER', 'center') + '</option>'
					+ '<option value="centerRight">' + Joomla.JText._('SLIDERCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft" selected="selected">' + Joomla.JText._('SLIDERCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter">' + Joomla.JText._('SLIDERCK_BOTTOMCENTER', 'bottom center') + '</option>'
					+ '<option value="bottomRight">' + Joomla.JText._('SLIDERCK_BOTTOMRIGHT', 'bottom right') + '</option>';
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="centerRight">' + Joomla.JText._('SLIDERCK_MIDDLERIGHT', 'center right') + '</option>'
					+ '<option value="bottomLeft">' + Joomla.JText._('SLIDERCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter" selected="selected">' + Joomla.JText._('SLIDERCK_BOTTOMCENTER', 'bottom center') + '</option>'
					+ '<option value="bottomRight">' + Joomla.JText._('SLIDERCK_BOTTOMRIGHT', 'bottom right') + '</option>';
			...
			imgdataalignmentoption = '<option value="default">Default</option>'
					...
					+ '<option value="bottomLeft">' + Joomla.JText._('SLIDERCK_BOTTOMLEFT', 'bottom left') + '</option>'
					+ '<option value="bottomCenter">' + Joomla.JText._('SLIDERCK_BOTTOMCENTER', 'bottom center') + '</option>'
					+ '<option value="bottomRight" selected="selected">' + Joomla.JText._('SLIDERCK_BOTTOMRIGHT', 'bottom right') + '</option>';
		} else {
			imgdataalignmentoption = '<option value="default" selected="selected">Default</option>'
					+ '<option value="topLeft">' + Joomla.JText._('SLIDERCK_TOPLEFT', 'top left') + '</option>'
					+ '<option value="topCenter">' + Joomla.JText._('SLIDERCK_TOPCENTER', 'top center') + '</option>'
	...
	ckslide.html('<div class="ckslidehandle"><div class="ckslidenumber">' + index + '</div></div>'
			+ '<div class="ckslidedelete cktip" title="' + Joomla.JText._('SLIDERCK_REMOVE2', '') + '" onclick="javascript:ckRemoveSlide(jQuery(this).parent());"><i class="fas fa-times"></i></a></div>'
			...
			+ '<div class="ckslideimgnamewrap ckbutton-group">'
				...
				+ '<a class="ckbutton cktip" onclick="ckCallImageManagerPopup(\'ckslideimgname' + index + '\')" href="javascript:void(0)" title="' + Joomla.JText._('SLIDERCK_SELECTIMAGE', 'select image') + '"><i class="fas fa-edit"></i></a></div>'
			+ '</div>'

			+ '<div class="cksliderow2">'
			// + '<span class="ckslidelabel">' + Joomla.JText._('SLIDERCK_USETOSHOW', 'Display') + '</span><select class="ckslideselect">' + slideselectoption + '</select>'
			+ '<span><i class="fas fa-hourglass-half cktip" title="' + Joomla.JText._('SLIDERCK_SLIDETIME', 'enter a specific time value for this slide, else it will be the default time') + '" style="color: #555;font-size: 16px;padding: 5px;"></i><input name="ckslideimgtime' + index + '" class="ckslideimgtime" type="text" value="' + imgtime + '" style="width:25px;" /></span><span>ms</span>'
			+ '</div>'
			
			+ '<div class="cksliderow"><div id="ckslideaccordion' + index + '">'
			+ '<span class="ckbutton ckslideaccordeonbutton ckinterfacetablink" data-group="main" data-tab="tab_maintext">' + Joomla.JText._('SLIDERCK_TEXT', 'Text') + '</span>'
//			+ '<span class="ckbutton ckslideaccordeonbutton ckinterfacetablink" data-group="main" data-tab="tab_mainimage">' + Joomla.JText._('SLIDERCK_IMAGE', 'Image') + '</span>'
			+ '<span class="ckbutton ckslideaccordeonbutton ckinterfacetablink" data-group="main" data-tab="tab_mainlink">' + Joomla.JText._('SLIDERCK_LINK', 'Link') + '</span>'
			+ '<span class="ckbutton ckslideaccordeonbutton ckinterfacetablink" data-group="main" data-tab="tab_mainvideo">' + Joomla.JText._('SLIDERCK_VIDEO', 'Video') + '</span>'
			+ '<span class="ckbutton ckslideaccordeonbutton ckinterfacetablink" data-group="main" data-tab="tab_maindates">' + Joomla.JText._('SLIDERCK_DATES', 'Dates') + '</span>'
			+ '<div style="clear:both;"></div>'

			+ '<div class="ckslideaccordeoncontent ckinterfacetab" data-group="main" id="tab_maintext">'
				+ '<span class="ckbutton ckslideaccordeonbutton ckinterfacetablink ' + (texttype == 'custom' ? 'active open' : '') + '" data-allowclose="false" data-group="text" data-tab="tab_textcustom" data-value="custom">' + Joomla.JText._('SLIDERCK_TEXT_CUSTOM', 'Custom text') + '</span>'
				+ '<span class="ckbutton ckslideaccordeonbutton ckinterfacetablink ' + (texttype == 'article' ? 'active open' : '') + '" data-allowclose="false" data-group="text" data-tab="tab_textarticle" data-value="article">' + Joomla.JText._('SLIDERCK_ARTICLE', 'Article') + '</span>'
				+ '<span class="ckbutton ckslideaccordeonbutton ckinterfacetablink ' + (texttype == 'pagebuilderck' ? 'active open' : '') + '" data-allowclose="false" data-group="text" data-tab="tab_textpagebuilderck" data-value="pagebuilderck">' + Joomla.JText._('SLIDERCK_PAGEBUILDERCK', 'Page Builder CK') + '</span>'
				+ '<div style="clear:both;"></div>'
				+ '<div class="ckslideaccordeoncontent ckinterfacetab ' + (texttype == 'custom' ? 'current' : '') + '" data-group="text" id="tab_textcustom">'
					+ '<div class="cksliderow"><span class="ckslidelabel">' + Joomla.JText._('SLIDERCK_TITLE', 'Title') + '</span><input name="ckslidetitletext' + index + '" class="ckslidetitletext" type="text" value="' + imgtitle + '" /></div>'
					+ '<div class="cksliderow"><span class="ckslidelabel">' + Joomla.JText._('SLIDERCK_CAPTION', 'Caption') + '</span><input name="ckslidecaptiontext' + index + '" class="ckslidecaptiontext" type="text" value="' + imgcaption + '" /></div>'
				+ '</div>'
				+ '<div class="ckslideaccordeoncontent ckinterfacetab ' + (texttype == 'article' ? 'current' : '') + '" data-group="text" id="tab_textarticle">'
					+ '<div class="cksliderow ckbutton-group" id="cksliderowarticle' + index + '"><label class="ckslidelabel">' + Joomla.JText._('SLIDERCK_ARTICLE_ID', 'Article ID') + '</label><input name="ckslidearticleid' + index + '" class="ckslidearticleid input-medium" id="ckslidearticleid' + index + '" style="width:20px" type="text" value="' + articleid + '" disabled="disabled" /><input name="ckslidearticlename' + index + '" class="ckslidearticlename input-medium" id="ckslidearticlename' + index + '" type="text" value="' + articlename + '" disabled="disabled" /><a id="ckslidearticlebuttonSelect" class="ckmodal ckbutton cktip" title="' + Joomla.JText._('SLIDERCK_SELECT', 'Clear') + '" href="index.php?option=com_content&amp;layout=modal&amp;view=articles&amp;tmpl=component&amp;function=jSelectArticle_ckslidearticleid' + index + '&' + SLIDERCK.TOKEN + '" rel="{handler: \'iframe\', size: {x: 800, y: 450}}"><i class="fas fa-mouse-pointer"></i></a><a class="ckbutton" href="javascript:void(0)" onclick="document.getElementById(\'ckslidearticleid' + index + '\').value=\'\';document.getElementById(\'ckslidearticlename' + index + '\').value=\'\';document.getElementById(\'ckslidearticlebuttonEdit' + index + '\').style.display=\'none\';">' + Joomla.JText._('SLIDERCK_CLEAR', 'Clear') + '</a>'
					+ '<a id="ckslidearticlebuttonEdit' + index + '" class="ckbutton" href="javascript:void(0)" onclick="ckCallArticleEditionPopup(document.getElementById(\'ckslidearticleid' + index + '\').value)" ' + (articleid != '' ? '' : 'style="display:none;"') + '>'+Joomla.JText._('SLIDERCK_EDIT', 'Edit')+'</a>'
					+'</div>'
				+ '</div>'
...
//					+'</div>'
					+'<div class="ckinfo"><i class="fas fa-info"></i><a href="https://www.joomlack.fr/en/joomla-extensions/slideshow-ck" target="_blank">' + Joomla.JText._('SLIDERCK_ONLY_PRO') + '</a></div>'
				+ '</div>'

			
			+ '</div>'
//			+ '<div class="ckslideaccordeoncontent ckinterfacetab" data-group="main" id="tab_mainimage">'
//			+ '<div class="cksliderow"><span class="ckslidelabel">' + Joomla.JText._('SLIDERCK_ALIGNEMENT_LABEL', 'Image alignment') + '</span><select name="ckslidedataalignmenttext' + index + '" class="ckslidedataalignmenttext" >' + imgdataalignmentoption + '</select></div>'
//			+ '</div>'
			+ '<div class="ckslideaccordeoncontent ckinterfacetab" data-group="main" id="tab_mainlink">'
				...
				+ '<div class="cksliderow">'
					...
					+ '<label class="ckslidelabel">' + Joomla.JText._('SLIDERCK_LINK', 'Link url') + '</label><input id="ckslidelinktext' + index + '" name="ckslidelinktext' + index + '" class="ckslidelinktext" type="text" value="' + imglink + '" />'
					+ '<a class="ckbutton cktip" onclick="ckCallMenusSelectionPopup(\'ckslidelinktext' + index + '\')" href="javascript:void(0)" title="' + Joomla.JText._('SLIDERCK_SELECT_LINK', 'select image') + '"><i class="fas fa-edit"></i></a>'
					+ '</div>'
				+ '</div>'
			+ '<div class="cksliderow"><span class="ckslidelabel">' + Joomla.JText._('SLIDERCK_TARGET', 'Target') + '</span><select name="ckslidetargettext' + index + '" class="ckslidetargettext" >' + imgtargetoption + '</select></div>'
			+ '</div>'
			+ '<div class="ckslideaccordeoncontent ckinterfacetab" data-group="main" id="tab_mainvideo">'
			+ '<div class="cksliderow">'
			+ '<div class="ckbutton-group">'
			+' <label class="ckslidelabel">' + Joomla.JText._('SLIDERCK_VIDEOURL', 'Video url') + '</label>'
			+ '<input id="ckslidevideotext' + index + '" name="ckslidevideotext' + index + '" class="ckslidevideotext" type="text" value="' + imgvideo + '" />'
			+ '<a class="ckbutton cktip" title="' + Joomla.JText._('SLIDERCK_SELECT', 'Clear') + '" href="javascript:void(0)" onclick="ckCallVideoManagerPopup(\'ckslidevideotext' + index + '\')"><i class="fas fa-edit"></i></a>'
			+ '</div>'
			+ '<div class="cksliderow">'
	...
	+ '<div class="cksliderow">'
			...
			+ '<div class="cksliderow"><span class="ckslidelabel">' + Joomla.JText._('SLIDERCK_STARTDATE', 'Start date') + '</span><input name="ckslidestartdate' + index + '" class="ckslidestartdate ckdatepicker" type="text" value="' + startdate + '" /></div>'
			+ '<div class="cksliderow"><span class="ckslidelabel">' + Joomla.JText._('SLIDERCK_ENDDATE', 'End date') + '</span><input name="ckslideenddate' + index + '" class="ckslideenddate ckdatepicker" type="text" value="' + enddate + '" /></div>'
			+ '</div>'
			+ '</div></div>'
...
function ckRemoveSlide(slide) {
	if (confirm(Joomla.JText._('SLIDERCK_REMOVE', 'Remove this slide') + ' ?')) {
		jQuery(slide).remove();
		ckStoreSlides();
	}
