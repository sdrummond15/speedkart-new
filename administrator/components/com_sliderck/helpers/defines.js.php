...
<script>
	var SLIDERCK = {
		...
		, ADMIN_URL : '<?php echo JUri::root(true) ?>/administrator/index.php?option=com_sliderck'
		, FRONT_URL : '<?php echo JUri::root(true) ?>/index.php?option=com_sliderck'
		, BASE_URL : '<?php echo JUri::base(true) ?>/index.php?option=com_sliderck'
