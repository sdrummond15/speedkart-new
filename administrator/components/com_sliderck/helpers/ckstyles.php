...
class CKStyles extends \stdClass {
	...
	";
		...
		// Arrows
		// normal state arrows
		$arrowcolor = (isset($fields->slidearrowcolor) AND $fields->slidearrowcolor != '') ? str_replace('#', '', $fields->slidearrowcolor) : "";
		$arrowopacity = (isset($fields->slidearrowopacity) AND $fields->slidearrowopacity != '') ? $fields->slidearrowopacity : "";
		if ($arrowcolor || $arrowopacity) {
			$styles .= "|ID| .swiper-button-prev {"
	...
	";
		...
		// hover state arrows
		$arrowhovercolor = (isset($fields->slidearrowhovercolor) AND $fields->slidearrowhovercolor != '') ? str_replace('#', '', $fields->slidearrowhovercolor) : "";
		$arrowhoveropacity = (isset($fields->slidearrowohoverpacity) AND $fields->slidearrowohoverpacity != '') ? $fields->slidearrowohoverpacity : "";
		if ($arrowcolor || $arrowopacity) {
			$styles .= "|ID| .swiper-button-prev:hover {"
	. ($arrowcolor ? "background-image: url(\"data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%2027%2044'%3E%3Cpath%20d%3D'M0%2C22L22%2C0l2.1%2C2.1L4.2%2C22l19.9%2C19.9L22%2C44L0%2C22L0%2C22L0%2C22z'%20fill%3D'%23" . $arrowhovercolor . "'%2F%3E%3C%2Fsvg%3E\");" : "")
	. ($arrowhoveropacity ? "opacity: " . $arrowhoveropacity . ";" : "")
						. "}
	";
			$styles .= "|ID| .swiper-button-next:hover {"
	. ($arrowcolor ? "background-image: url(\"data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg'%20viewBox%3D'0%200%2027%2044'%3E%3Cpath%20d%3D'M27%2C22L27%2C22L5%2C44l-2.1-2.1L22.8%2C22L2.9%2C2.1L5%2C0L27%2C22L27%2C22z'%20fill%3D'%23" . $arrowhovercolor . "'%2F%3E%3C%2Fsvg%3E\");" : "")
	. ($arrowhoveropacity ? "opacity: " . $arrowhoveropacity . ";" : "")
						. "}
	";
		}
		...
		// Pagination
		// normal state pagination
		$paginationcolor = (isset($fields->slidepaginationcolor) AND $fields->slidepaginationcolor != '') ? $fields->slidepaginationcolor : "";
		$paginationopacity = (isset($fields->slidepaginationopacity) AND $fields->slidepaginationopacity != '') ? $fields->slidepaginationopacity : "";
		if ($paginationcolor || $paginationopacity) {
			$styles .= "|ID| .swiper-pagination-bullet {"
	...
	";
		...
		$paginationactivecolor = (isset($fields->slidepaginationactivecolor) AND $fields->slidepaginationactivecolor != '') ? $fields->slidepaginationactivecolor : "";
		$paginationactiveopacity = (isset($fields->slidepaginationactiveopacity) AND $fields->slidepaginationactiveopacity != '') ? $fields->slidepaginationactiveopacity : "";
		if ($paginationactivecolor || $paginationactiveopacity) {
			$styles .= "|ID| .swiper-pagination-bullet-active {"
	. ($paginationactivecolor ? "background: " . $paginationactivecolor . ";" : "")
	. ($paginationactiveopacity ? "opacity: " . $paginationactiveopacity . ";" : "")
						. "}
	";
		}
