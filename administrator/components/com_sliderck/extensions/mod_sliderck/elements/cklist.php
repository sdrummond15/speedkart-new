...
class JFormFieldCklist extends JFormField {
	...
	protected function getInput() {
		...
		// Create a regular list.
			...
			$html[] = $icon ? '<div style="display:inline-block;vertical-align:top;width:20px;"><img src="' . SLIDERCK_MEDIA_URI . '/images/' . $icon . '" style="margin-right:5px;" /></div>' : '<div style="display:inline-block;width:20px;"></div>';
	...
	protected function getLabel() {
		...
		// <strong>Select a folder</strong><br />Choose the folder from which to load the images. You can write the path directly or select it with the interface.
