...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_competitions&task=kartings.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_competitions&view=kartings'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="table table-striped" id="articleList">
        ...
        <tr>
            ...
            <th width="40%" class="nowrap center">
                <?php echo JHtml::_('grid.sort', 'COM_COMPETITIONS_HEADING_KARTING', 'a.title', $listDirn, $listOrder); ?>
            </th>
            <th width="1%" class="nowrap center hidden-phone">
        ...
        foreach ($this->items as $i => $item) :
            ...
            <tr class="row<?php echo $i % 2; ?>">
                ...
                <td class="center">
                    <div class="btn-group">
                        <?php echo JHtml::_('jgrid.published', $item->published, $i, 'kartings.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
                        <?php
                        // Create dropdown items
                        $action = $archived ? 'unarchive' : 'archive';
                        JHtml::_('actionsdropdown.' . $action, 'cb' . $i, 'kartings');
                ...
                <td class="nowrap has-context">
                    <div class="center">
                        <?php if ($item->checked_out) : ?>
                            <?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'kartings.', $canCheckin); ?>
                        <?php endif; ?>
                        <?php if ($canEdit || $canEditOwn) : ?>
                            <a href="<?php echo JRoute::_('index.php?option=com_competitions&task=karting.edit&id=' . (int)$item->id); ?>">
