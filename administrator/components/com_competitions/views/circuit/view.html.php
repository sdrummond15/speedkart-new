...
class CompetitionsViewCircuit extends JViewLegacy
{
    protected $form;
    protected $item;
    protected $state;
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title($isNew ? JText::_('COM_COMPETITIONS_CIRCUIT_ADD') : JText::_('COM_COMPETITIONS_CIRCUIT_EDIT'), 'circuito.png');
		...
		JToolBarHelper::help('JHELP_COMPONENTS_COMPETITIONS_CIRCUIT_EDIT');
	}
}