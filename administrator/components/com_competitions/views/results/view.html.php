 ...
 * @since 2.5
 */
class CompetitionsViewResults extends JViewLegacy
{
    protected $items;
    protected $paginaton;
    protected $state;
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(JText::_('COM_COMPETITIONS_MANAGER_RESULTS'), 'resultado.png');
        ...
        if ($this->state->get('filter.state') != -1) {
            JToolBarHelper::divider();
            if ($this->state->get('filter.state') != 2) {
                JToolBarHelper::archiveList('results.archive');
            } elseif ($this->state->get('filter.state') == 2) {
                JToolBarHelper::unarchiveList('results.publish');
            }
        }

        JToolBarHelper::checkin('results.checkin');
        ...
        JToolBarHelper::trash('results.trash');
        JToolBarHelper::divider();

        JToolBarHelper::preferences('com_competitions');
        JToolBarHelper::divider();

        JToolBarHelper::help('results', $com = true);
    }
