 ...
 * @since 2.5
 */
class CompetitionsViewGrids extends JViewLegacy
{
    protected $items;
    protected $paginaton;
    protected $state;
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(JText::_('COM_COMPETITIONS_MANAGER_GRIDS'), 'grid.png');
        ...
        if ($this->state->get('filter.state') != -1) {
            ...
            if ($this->state->get('filter.state') != 2) {
                ...
                JToolBarHelper::unarchiveList('grids.publish');
            }
        }
        ...
        JToolBarHelper::help('grids', $com = true);
    }
