...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_competitions&task=grids.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_competitions&view=grids'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <table class="table table-striped" id="articleList">
        ...
        <tr>
            ...
            <th width="40%" class="nowrap center">
                <?php echo JHtml::_('grid.sort', 'COM_COMPETITIONS_STAGE', 's.title', $listDirn, $listOrder); ?>
            </th>
            <th width="10%" class="nowrap center">
                <?php echo JHtml::_('grid.sort', 'COM_COMPETITIONS_CHAMPIONSHIP', 'c.title', $listDirn, $listOrder); ?>
            </th>
            <th width="1%" class="nowrap center hidden-phone">
        ...
        foreach ($this->items as $i => $item) :
            ...
            <tr class="row<?php echo $i % 2; ?>">
                ...
                <td class="center">
                    <div class="btn-group">
                        <?php echo JHtml::_('jgrid.published', $item->published, $i, 'grids.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
                        <?php
                ...
                <td class="nowrap has-context">
                    <div class="center">
                        ...
                        <?php if ($canEdit || $canEditOwn) : ?>
                            <a href="<?php echo JRoute::_('index.php?option=com_competitions&task=grid.edit&id=' . (int)$item->id); ?>">
                                <?php echo $this->escape($item->etapa); ?>
                            </a>
                        <?php else : ?>
                            <?php echo $this->escape($item->etapa); ?>
                        <?php endif; ?>
