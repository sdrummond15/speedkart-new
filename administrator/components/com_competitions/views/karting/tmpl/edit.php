...
<script type="text/javascript">
    Joomla.submitbutton = function (task) {
        if (task == 'karting.cancel' || document.formvalidator.isValid(document.id('karting-form'))) {
            Joomla.submitform(task, document.getElementById('karting-form'));
        }
    }
</script>

<form action="<?php echo JRoute::_('index.php?option=com_competitions&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="karting-form" class="form-validate">
    ...
    <div class="form-horizontal">
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', empty($this->item->id) ? JText::_('COM_COMPETITIONS_NEW_KARTING', true) : JText::_('COM_COMPETITIONS_EDIT_KARTING', true)); ?>
        <div class="row-fluid">
            <div class="span9">
