...
class StagesControllerStages extends JControllerForm
{
    ...
    public function contract_data()
    {
        ...
        try {
            ...
            if (!isset($_POST['id']) || empty($_POST['id'])) {
                ...
                $mainframe->redirect(JRoute::_('index.php?option=com_stages&view=stage'));
                return false;
            }
        ...
        $mainframe->redirect(JRoute::_('index.php?option=com_stages&view=stage&id='.$id));
