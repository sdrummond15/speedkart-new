...
class PilotsControllerPilots extends JControllerForm
{
    ...
    public function contract_data()
    {
        ...
        try {
            ...
            if (!isset($_POST['id']) || empty($_POST['id'])) {
                ...
                $mainframe->redirect(JRoute::_('index.php?option=com_pilots&view=pilot'));
                return false;
            }
        ...
        $mainframe->redirect(JRoute::_('index.php?option=com_pilots&view=pilot&id='.$id));
...
class PHP_email extends PHPMailer {
    ...
    function email_confirma_contrato($user, $id) {
        ...
        $mail->setBody(
            ...
            . '<p><a href="'.JURI::base().'index.php/imoveis/pilot/'.$id.'" target="_blank">Clique aqui e veja seu imóvel.</a></p>'
            . '</body>'
            . '</html>');
